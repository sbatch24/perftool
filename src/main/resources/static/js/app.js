(function () {
    ...
    app.factory("perftoolfactory", ['$http' , function($http){
        
        /*
         * Factory class that is responsible for providing services that the Performance tool UI needs to
         * call the backend systems.
         */
        var perftoolfactory = {
            
            /* 
             * Call is made to initialize the Perf tool UI with the configuration that is on the backend server.
             */
            initConfig : function() {
            ...
            /*
             * This service call is made to update the configuration back to the server.
             */
